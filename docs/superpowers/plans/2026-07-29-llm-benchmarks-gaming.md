...
const TYPES: TypeInfo[] = [
	{
		...
		filter: 'SWE-bench Verified: 93 разработчика, по 3 аннотатора на пример, 500 задач в финальном сете (OpenAI отдельно называет долю помеченных как проблемные — 68.3% — с 1699 к 500 в простой процент не сводится)',
