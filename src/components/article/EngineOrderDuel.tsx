	...
	return (
		<div style={css.wrap}>
			...
			<div style={css.desc}>
				...
				посмотри, когда порядок вообще не важен, а когда важен критически.
			</div>
			...
			<div style={css.topkNote}>top_k: выключен (зафиксирован — чтобы сравнивать только эффект порядка min_p и top_p)</div>
