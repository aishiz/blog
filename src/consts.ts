...
// YANDEX_VERIFICATION — код подтверждения (Вебмастер → добавить сайт → способ «Мета-тег»,
//   только содержимое атрибута content, без самого <meta>).
// GOOGLE_SITE_VERIFICATION — то же самое для Search Console → «Тег HTML» → только content.
export const YANDEX_METRIKA_ID = '111055223';
