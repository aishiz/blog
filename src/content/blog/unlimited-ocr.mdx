...
description: 'Unlimited-OCR от Baidu — 3B vision-language модель для OCR документов в духе DeepSeek-OCR: оптическое сжатие, режимы gundam/base, запуск через SGLang.'
pubDate: 'Jun 25 2026'
category: 'модели'
---
