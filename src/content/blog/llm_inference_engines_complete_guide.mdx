...
<StepList steps={[
	...
	{ num: "5", text: "<strong>Спекулятивное декодирование</strong> — маленькая модель генерит черновик, большая проверяет. Параллелизм на уровне токенов. Разбирал механику <a href='/blog/speculative-decoding/'>отдельно</a>" },
